...
Grid.prototype.onCreated = function()
{
	...
	for (var i = 100; i--;)
	{
		var person = this.state.createObject('Person', this);
		person.speed = random(10, 20) / 20;
...
Grid.prototype.onUpdate = function()
{
	//this.center();
}

Grid.prototype.onDraw = function(_2d, delta)
{
	
}

Grid.prototype.onDrawIsometric = function(_2d, delta)
{
	//_2d.fillStyle = 'orange';
	//_2d.fillRect(this.getX(), this.getY(), this.getWidth(), this.getHeight());
	
	var mouseIso = screenToIso(this.state.statemanager.gamemanager.renderer.mouse);
